...
// ============================================
// ✅ NORMALIZADOR: garantir que horários seja sempre string[]
// (Algumas funções retornam { horarios, status, motivo })
// ============================================
...
export const validarEEnriquecerContexto = async (
  ...
  try {
    ...
    // ✅ VALIDAÇÃO CRÍTICA 1: HORÁRIO NO PASSADO (ANTES DE TUDO!)
